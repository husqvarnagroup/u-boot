...
`@iter->part` parameter. If there are any bootable partitions in the table, i.e.
have the MBR bootable flag set or are of type "EFI System Partition", then only
those partitions are considered.
